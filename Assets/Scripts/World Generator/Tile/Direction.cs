...
namespace Assets.Scripts.WorldGenerator.Tile
{
    ...
    public static class Direction
    {
        ...
        private static readonly int3[] directions = {East, NorthEast, NorthWest, West, SouthWest, SouthEast};
        ...
        /// <summary> Iterable list of valid directions. </summary>
        public static ref readonly int3[] Directions => ref directions;
    }
}
